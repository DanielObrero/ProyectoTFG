...
class MonumentosAdapterVista(private var rutas:ArrayList<Monumentos>, var listener: OnClickListener) :
RecyclerView.Adapter<MonumentosAdapterVista.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view=LayoutInflater.from(mContext).inflate(R.layout.monumentosvista,parent,false)
